...
export const MainLayout = () => {
    ...
    return (
        <div className="container-fluid" style={{ background: 'linear-gradient(#88B6F2, #9049BF)' }}>
            <div className="row">
                ...
                <div
                    className={`col-md-7 col-lg-8 col-12 p-0 ${selectedContact ? 'sliding' : ''}`}
                    style={{
                        position: 'relative',
                        overflow: 'hidden',
                ...
                >
                    ...
                    >
                        {selectedContact ? (
                            <>
                                <NameBar selectedContact={selectedContact} setSelectedContact={handleBack} />
                                <Chat
                                    messages={messages}
